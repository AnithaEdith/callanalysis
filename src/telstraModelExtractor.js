  ...
  return new Promise(resolve => {
    ...
    if(monkeyenabled) {
      ...
      const MonkeyLearn = require('monkeylearn')
        ...
        const ml = new MonkeyLearn(process.env.MONKEY_EXTRACTOR_LICENSE_KEY)
        
        // Classify some texts
        let model_id = process.env.MONKEY_EXTRACTOR_MODEL_ID
        // the full options are described in the docs: https://api.monkeylearn.com/v3/extractors/ex_iwn4Wvy3/extract/
